...
//        connection.setDoOutput(true);
        ...
        String janCode = inputObject.getJsonString("jan");
        String rank = inputObject.getJsonString("rank");
        String point = inputObject.getJsonString("point");
        String storeCode =inputObject.getJsonString("storeCode");
